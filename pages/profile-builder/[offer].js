  ...
  return(
    <Script>
      <div className={`${headStyle.subTitleGlobal} ${pricingPlan.global}`}>
          ...
          <Link href={`https://api.vendmy.com/leny/stripe/create-checkout-session.php?url=${process.env.EXTENSION}://${process.env.HOSTNAME}${process.env.PORT}&offer=${offerProps}`} passHref>
